...
const testimonialslide = [
  {
    ...
    post: "CEO & Founder",
    comment:
      "On the other hand we denounce with righteou indg ation and dislike men who are so beguiled and demoraliz ed by the charms of pleasure of the moment /n the moment",
  },
  {
    img: testimonialauthor,
    name: "Richard E. Harrisona",
