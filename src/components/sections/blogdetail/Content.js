...
const relatedpost = [
  {
    img: latest1,
    title: " How Performance Visiblety With GitLab CI & Hood",
    urltext: "Learn More",
                ...
                <div className="post-meta">
                  <ul>
                    <li>
                      ...
                      <Link to="/blogdetail">Nichel Jhon</Link>
                    </li>
                    <li>
                      <i className="far fa-calendar-alt" />
                      <Link to="/blogdetail">25 Aug 2020</Link>
                    </li>
                    <li>
                      <i className="far fa-comments" />
                      <Link to="/blogdetail">Comments (05)</Link>
                    </li>
                  </ul>
                </div>
                <div className="post-content">
                  <h3 className="title">
                    Inspired Design Decisions With Herb Typography Can Be As
                    Exciting As Illustration &amp; Photo
                  </h3>
                  <p>
                  ...
                  <h4 className="with-check">
                    <i className="far fa-check-circle" /> Inspired Design
                    Decisions With Otto Storch When Idea Copy
                  </h4>
                  <p>
              ...
              <div className="post-nav row">
                <div className="prev-post col-md-6">
                  ...
                  <div className="content">
                    <span className="date">
                      <i className="far fa-calendar-alt" /> 25 Aug 2020
                    </span>
                    <h5>
                      <Link to="/blogdetail">
                ...
                <div className="next-post col-md-6">
                  <div className="content">
                    <span className="date">
                      25 Aug 2020 <i className="far fa-calendar-alt" />
                    </span>
                    <h5>
                      <Link to="/blogdetail">
                  ...
                  <li>
                    ...
                    <div className="comment-content">
                      <h5 className="author-name">
                        John F. Medina<span className="date">25 July 2020</span>
                      </h5>
                      <p>
                        But I must explain to you how all this mistaken idea of
                        denouncing pleasure and praising pawas born and I will
                        give you a complete account
                      </p>
                      <Link to="#" className="reply-btn">
                        Reply <i className="far fa-long-arrow-alt-right" />
                      </Link>
                    </div>
                      ...
                      <li>
                        ...
                        <div className="comment-content">
                          ...
                          <p>
                            ...
                            desires to obtain paiits ecause it is pain, but
